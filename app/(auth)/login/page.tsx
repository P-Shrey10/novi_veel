        ...
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
          <Link href="/" className="flex items-center gap-2">
            <Image
              ...
              priority
            />
            <span className="text-xl font-bold">Novi</span>
          </Link>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8 sm:p-10">
            ...
            <div className="space-y-3 mb-6">
              <Button
                type="button"
                variant="outline"
                className="w-full h-11 border-slate-300 hover:border-slate-400 hover:bg-slate-50"
            ...
            <div className="relative my-6">
              <Separator />
              <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-4 text-xs text-slate-500 uppercase">
                Or
              </span>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button
                type="submit"
                className="w-full h-11 bg-indigo-600 hover:bg-indigo-700 text-white font-medium shadow-lg shadow-indigo-600/20"
              >
                Sign in
              </Button>
            </form>
